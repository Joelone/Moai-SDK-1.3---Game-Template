...
function update_score()
	...
	scorebox:setLoc(0,(screen_height/2*-1)+30)
	...
	scorebox_shadow:setLoc(0+2,(screen_height/2*-1)-2+30)
...
-- pointer DOWN
	...
	----print ("yDown="..yDown)
		...
		if gamepick then
			if (gamepick.name=="Player" or gamepick.name=="Player1" or gamepick.name=="Player2" or gamepick.name=="Player3") then
...
function add_actor(x,y,width,height,density,friction,restitution,actorname,treasure,bodytype,texture_image,particle_texture,smoke_texture,welded,health,points)
